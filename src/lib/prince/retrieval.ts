...
const SYNONYMS: Record<string, string[]> = {
  ...
  invest: ["investor", "investment", "capital", "fund"],
  investor: ["investment", "invest", "capital", "fund"],
  investment: ["investor", "invest", "capital"],
  return: ["payout", "profit", "roi", "target"],
  profit: ["return", "payout"],
